...
Maximum size of the log file before it's rotated (eg `10M`). This SIZE
...
For example if the following flags are in use
    ...
    --log-file rclone.log --log-file-max-size 1M --log-file-max-backups 3

Then this will create log files which look like this

```text
-rw-------  1 ncw ncw  1048491 Apr 11 17:15 rclone-2025-04-11T17-15-29.998.log
-rw-------  1 ncw ncw  1048511 Apr 11 17:15 rclone-2025-04-11T17-15-30.467.log
-rw-------  1 ncw ncw  1048559 Apr 11 17:15 rclone-2025-04-11T17-15-30.543.log
-rw-------  1 ncw ncw   521602 Apr 11 17:15 rclone.log
```
